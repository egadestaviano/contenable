    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div className="relative w-full max-w-xl mx-auto mb-16">
        <form onSubmit={handleSubmit} className="relative">
          ...
          <button
            type="submit"
            className="absolute right-2 top-1/2 -translate-y-1/2 px-4 py-1.5 cursor-pointer bg-custom-primary text-white text-sm font-medium hover:bg-custom-primary-hover dark:hover:bg-white dark:hover:text-black transition-all duration-300 hidden sm:block"
